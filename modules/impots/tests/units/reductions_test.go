...
var ReductionTC = []struct {
	...
	},
	{
		Name:         "10% reduction",
		InitialTaxe:  1000,
		Reductions:   []reduction_domain.ReductionParameters{{"PERCENT", 10}},
		ExpectedTaxe: 900,
	},
	{
		Name:         "200 fixe reduction",
		InitialTaxe:  1000,
		Reductions:   []reduction_domain.ReductionParameters{{"FIXE", 200}},
		ExpectedTaxe: 800,
	},
	{
		Name:         "10% + 200 fixe reduction",
		InitialTaxe:  1000,
		Reductions:   []reduction_domain.ReductionParameters{{"PERCENT", 10}, {"FIXE", 200}},
		ExpectedTaxe: 700,
	},
	{
		Name:         "(2x percents) 10% + 20%+ 200 fixe reduction",
		InitialTaxe:  1000,
		Reductions:   []reduction_domain.ReductionParameters{{"PERCENT", 10}, {"PERCENT", 20}, {"FIXE", 200}},
		ExpectedTaxe: 600,
	},
	{
		Name:         "(2x percents + 2x fixes) 10% + 20%+ 200 fixe reduction",
		InitialTaxe:  1000,
		Reductions:   []reduction_domain.ReductionParameters{{"PERCENT", 10}, {"PERCENT", 20}, {"FIXE", 200}, {"FIXE", 100}},
		ExpectedTaxe: 500,
	},
}
...
func TestReductions(t *testing.T) {
	for _, tc := range ReductionTC {
		t.Run(tc.Name, func(t *testing.T) {
			reductions, err := reduction_domain.NewReductionsHandler(tc.Reductions)
			assert.Nil(t, err)
